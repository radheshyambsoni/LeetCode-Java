...
public class MinCostClimbingStairs_746 {
    ...
    public int minCostClimbingStairs(int[] cost) {
        ...
        // tabulation
        // but with a catch
        // in memoization, we did not have a method to check if the value required is
        // calculated or not
        // i.e the condition in memoization if we eleminate the dp array from the
        // scenario
        // but here we can use cost itself to store the values
        // so no more need of space optimization
        // In other words the tabulation would just use dp array to store values instead
        // of cost and space optimization won't
